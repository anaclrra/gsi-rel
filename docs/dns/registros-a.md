...
- samba-tool dns query 127.0.0.1 "alagoas.lab" @ ALL -U administrator
    ...
    - ![saída](./assets/samba-tool-dns-query.png)

Adicione os registros A, cada um associando um nome de host a um endereço IP específico.

 - ![saída](./assets/samab-tool-dns-add-penedo.png "Adiciona Host Penedo")
 - ![saída](./assets/samba-tool-dns-add-maragogi.png "Adiciona Host Maragogi")
 - ![saída](./assets/samba-tool-dns-add-piranhas.png "Adiciona Host Piranhas")
 ...
 - ![saída](./assets/samba-tool-dns-query_2.png "Verifica hosts adicionados")
